...
ActiveRecord::Schema.define(version: 2021_12_11_123923) do
  ...
  create_table "likes", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["sighting_id", "user_id"], name: "index_likes_on_sighting_id_and_user_id", unique: true
    t.index ["sighting_id"], name: "index_likes_on_sighting_id"
    t.index ["user_id"], name: "index_likes_on_user_id"
  end

  create_table "sightings", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.float "longitude"
    t.float "latitude"
